...
export default defineAi({
  id: 'ai-deepseek', label: 'DeepSeek', defaultModel: 'deepseek-chat',
  ...
  setup: tokenSetup({ secretKey: 'DEEPSEEK_API_KEY', label: 'DeepSeek', vendorDocUrl: 'https://platform.deepseek.com/api_keys', steps: ['Open platform.deepseek.com → API Keys', 'Copy the key (starts with sk-…)', 'Paste below'] }),
});
