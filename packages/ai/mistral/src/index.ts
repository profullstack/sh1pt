...
// Mistral Chat Completions. Compatible with any Mistral-protocol server
...
const DEFAULT_BASE = 'https://api.mistral.com';

export default defineAi<Config>({
  id: 'ai-mistral',
  label: 'Mistral',
  defaultModel: 'mistral-large-latest',
  models: ['mistral-large-latest', 'mistral-large-latest-mini', 'o1', 'o1-mini', 'o3-mini'],
  ...
  async generate(ctx, prompt, opts, config) {
    ...
    if (config.organization) headers['mistral-organization'] = config.organization;
  ...
  setup: tokenSetup({
    ...
    label: 'Mistral',
    vendorDocUrl: 'https://platform.mistral.com/api-keys',
    steps: ['Go to Mistral Console', 'Create API Key', 'Paste below'],
    fields: [
