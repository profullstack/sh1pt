...
export default defineAi({
  id: 'ai-mistral', label: 'Mistral', defaultModel: 'mistral-large-latest',
  ...
  setup: tokenSetup({ secretKey: 'MISTRAL_API_KEY', label: 'Mistral', vendorDocUrl: 'https://console.mistral.ai/api-keys', steps: ['Open console.mistral.ai → API Keys', 'Copy the key', 'Paste below'] }),
});
