...
- Name: `@profullstack/sh1pt-payment-transfi`
- Path: `packages/payments/transfi`
- Adapter ID: `payment-transfi`
...
```bash
pnpm add @profullstack/sh1pt-payment-transfi
```

## Development

```bash
pnpm --filter @profullstack/sh1pt-payment-transfi typecheck
```
