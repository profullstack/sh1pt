...
export default definePayment<Config>({
  ...
  setup: tokenSetup<Config>({
    ...
    steps: [
      'TransFi is the BREADTH partner: one key serves 41 corridors.',
      'Budget for it: KYB review is 1-14 business days, then production',
      '  keys within 24h of verification. Bitnob is 24-48h if you need a',
      '  single African corridor live sooner.',
      '',
      ...
      'Send the documents to compliance@transfi.com to start verification',
      'UBOs need a government-issued ID and proof of address',
      '',
      'The webhook secret is available BEFORE KYB clears — set that up first',
      '  so the integration is provable while verification runs',
      '',
