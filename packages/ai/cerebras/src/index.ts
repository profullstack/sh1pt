...
export default defineAi({
  id: 'ai-cerebras', label: 'Cerebras', defaultModel: 'llama3.1-70b',
  ...
  setup: tokenSetup({ secretKey: 'CEREBRAS_API_KEY', label: 'Cerebras', vendorDocUrl: 'https://cloud.cerebras.ai/platform', steps: ['Open cloud.cerebras.ai → API Keys', 'Copy the key', 'Paste below'] }),
});
